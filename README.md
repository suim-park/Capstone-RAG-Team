...
## Experiments
We evaluated our GraphRAG-based system using a curated dataset consisting of 36 yes-no medical questions and 112 research papers related to critical care medicine. For each question, the model retrieved relevant documents, classified their stance (support, neutral, against), and synthesized factual summaries. Performance was assessed using standard metrics—including accuracy, precision, recall, and F1-score—for both retrieval and stance classification tasks, as well as semantic similarity scores for study design, population, intervention, and outcome components in the PICO-formatted summaries.
